...
### 🌐 Da-Bubble
Eine Kommunikationsplattform mit Echtzeit-Chat, umgesetzt als Progressive Web App (PWA). Fokus lag auf klarer Struktur, guter Usability und effizienter Team-Kommunikation.

### 📋 Task-Management-Web-App
Webanwendung zur Organisation und Verwaltung von Aufgaben für mehrere Nutzer.  
Zusätzlich integriert: eine interaktive Enzyklopädie zur Visualisierung von Charakterdaten auf Basis von REST-APIs und Chart.js.
...
[🌍 ammann-customs.ch](https://ammann-customs.ch)
